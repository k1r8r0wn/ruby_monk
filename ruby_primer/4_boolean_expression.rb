...
# Let us say you are trying to recruit team-members for your new startup! Given a candidate, you need an
# expression that will tell you whether they fit into certain types. This is how a candidate object would look:
...
# or more can apply. And there is one more catch: Ruby being a cool and awesome language,
# a lot of smart youngsters are very good at it. We love those kids, but for this particular job we'd rather have
# them study at school than work. Let us filter out candidates who are younger than 15.
...
# For each condition you get correct, some tests will start passing. As your expression matures to take
# care of all the criteria, all the tests will pass and you'll have a green flag. Now, march on!

class Candidate
  def years_of_experience = 4

  def github_points = 293

  def languages_worked_with = %w[C Ruby Python Clojure]

  def applied_recently? = false
...
p is_an_experienced_programmer
